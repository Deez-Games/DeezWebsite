  ...
  return (
    <div className="flex flex-col justify-around absolute bottom-10 left-10 z-20 gap-y-10">
      ...
      <label className="flex justify-evenly gap-x-10 text-center text-lg">
        <span className="px-5 py-2 tracking-wide uppercase w-1/2 bg-primary-button">
          check out
        </span>
        <span className="px-5 py-2 tracking-wide uppercase w-1/2 bg-secondary-button text-black">
          trailer
        </span>
      </label>
    </div>
