...
const AboutUs = () => {
  return (
    <div
      id="AboutUs"
      className="flex flex-col-reverse md:flex-row gap-6 overflow-hidden bg-brightBg text-black px-6 sm:px-12 2xl:px-32 py-12 sm:py-24"
    >
      ...
      <div className="lg:text-right flex flex-col justify-center items-center">
        <div>
          ...
          <div className="flex justify-end">
            <p className="text-lg xl:text-2xl xl:max-w-[65%]">
