...
const NewsLetter = () => {
  return (
    ...
    <div
      id="Contact"
      className="h-[50vh] p-[5%] flex items-center justify-center space-x-6"
    >
      <div className="flex flex-col bg-gray-900 p-10 shadow-lg space-y-10 w-[900px]">
        <h3 className="text-5xl whitespace-nowrap font-bold flex items-center">
          Subscribe to newsletter!
        </h3>
        <div className="grid grid-cols-3 gap-y-3 gap-x-6">
          <input
            ...
            placeholder="e-mail"
          />
          <button className="bg-violet uppercase tracking-wider">
            Subscribe
          </button>
